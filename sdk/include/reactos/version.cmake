...
set(KERNEL_VERSION_DISPLAY "${KERNEL_VERSION_MAJOR}.${KERNEL_VERSION_MINOR}.${KERNEL_VERSION_PATCH_LEVEL}")
if(NOT KERNEL_VERSION_BUILD_TYPE STREQUAL "")
    set(KERNEL_VERSION_DISPLAY "${KERNEL_VERSION_DISPLAY}-${KERNEL_VERSION_BUILD_TYPE}")
endif()
...
if((EXISTS "${REACTOS_SOURCE_DIR}/.git") AND (NOT NO_REACTOS_BUILDNO))
    ...
    if(GIT_FOUND)
        ...
        if(GIT_CALL_RESULT EQUAL 0)
            string(REGEX REPLACE "^[0-9]+\\.[0-9]+\\.[0-9]+(-[A-Za-z0-9]+)?-" "" GIT_DESCRIBE_SUFFIX "${GIT_DESCRIBE_REVISION}")
            if(GIT_DESCRIBE_SUFFIX STREQUAL GIT_DESCRIBE_REVISION)
                set(REVISION "${KERNEL_VERSION_DISPLAY}-${GIT_DESCRIBE_REVISION}")
            else()
                set(REVISION "${KERNEL_VERSION_DISPLAY}-${GIT_DESCRIBE_SUFFIX}")
            endif()
        endif()
    endif()
endif()
