...
#define IOCTL_CONSOLE_CLEAR_SCREEN              CTL_CODE(FILE_DEVICE_SCREEN, 0x814, METHOD_BUFFERED, FILE_WRITE_ACCESS)
...
typedef struct tagCONSOLE_CLEAR_SCREEN
{
    CHAR   cCharacter;
    USHORT wAttribute;
} CONSOLE_CLEAR_SCREEN, *PCONSOLE_CLEAR_SCREEN;
